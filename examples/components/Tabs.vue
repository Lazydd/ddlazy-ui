<template>
    <div class="page-box">
        <h2 class="_title">Tabs 标签页</h2>
        <p class="_descript">分隔内容上有关联但属于不同类别的数据集合。</p>
        ...
        <dd-block title="选项卡样式" :code="code2">
            <template #source>
        ...
        <dd-block title="icon图标标签页" :code="code4">
            <template #source>
